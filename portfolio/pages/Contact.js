          ...
          <form action="#" className="contact__form">
            ...
            <div className="top-input">
              <div className="form__group first-input inputs-group">
                <input
                  onChange={(e) => this.handleChange("name", e.target)}
                  type="text"
            ...
            <div className="form__group">
              <textarea
                onChange={(e) => this.handleChange("message", e.target)}
            ...
            <div className="radio">
              <div className="radio-buttons">
                <div className="form__radio-group">
                  <input
                    onChange={(e) => this.handleButton("hiring", e)}
                    type="radio"
                    className="form__radio-input"
                    id="small"
                    name="size"
                    value={this.state.hiring}
                  />
                ...
                <div className="form__radio-group">
                  <input
                    onChange={(e) => this.handleButton("project", e)}
                    type="radio"
                    className="form__radio-input"
                    id="large"
                    name="size"
